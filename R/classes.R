...
setClass( "ldlasso", representation( geno = "matrix", pheno = "integer", s1 = "numericOrNULL", s2 = "numeric", r2 = "numeric", beta = "numeric", OR = "numeric", logOR.norm = "numeric" ) )
...
function( geno, pheno, s1, s2, r2 )
{
  ...
  new( "ldlasso", geno = geno, pheno = pheno, s1 = s1, s2 = s2, r2 = r2, OR = logOR.obj$OR, logOR.norm = logOR.obj$y )
}
