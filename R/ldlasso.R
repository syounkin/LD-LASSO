setGeneric("ldlasso", signature = c("ldlasso.obj"), function( ldlasso.obj ) standardGeneric("ldlasso") )
setMethod("ldlasso", signature("ldlasso"), function( ldlasso.obj ){
  ...
  return(list(  qp = qp, y = y, A = A, r2.vec = r2.vec, b0 = b0, OR = OR ))
